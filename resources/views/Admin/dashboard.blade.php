    ...
    <div class="flex h-screen">
        <div class="w-1/5 bg-white text-black flex flex-col p-4">
            ...
            <nav>
                <ul>
                    <li class="mb-4">
                        <a href="#"
                            class="font-medium block p-2 rounded text-black hover:bg-[#3E81AB] hover:text-white"
                            onclick="showContent('dashboard')">Dashboard</a>
                    </li>
                    <li class="mb-4">
                        <a href="#"
                            class="font-medium block p-2 rounded text-black hover:bg-[#3E81AB] hover:text-white"
                            onclick="showContent('billing')">Billing</a>
                    </li>
                    <li class="mb-4">
                        <a href="#"
                            class="font-medium block p-2 rounded text-black hover:bg-[#3E81AB] hover:text-white"
                            onclick="showContent('laporan')">Laporan</a>
                    </li>
                </ul>
            </nav>
            <div class="mt-auto">
        ...
        <div class="w-4/5 p-6" id="content-area">
            <div class="w-full bg-gray-100 py-3 mb-8 flex justify-between items-center">
                <div class="text-gray-500">Pages / <span id="breadcrumb" class="font-normal text-black">Dashboard</span>
                </div>
            ...
            <div id="billing" class="content-section hidden">
                ...
                <p>Kontrol billing perangkat dengan cepat. Pantau status perangkat aktif dan non-aktif dalam satu
                    tampilan.</p>
            </div>
