    ...
    <div class="max-w-screen-xl mx-auto px-2 md:px-2">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-6 mb-2">
            <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-2">
                ...
                <button onclick="openModal('modalAddPromo')" class="bg-[#3E81AB] text-white px-4 py-1.5 rounded text-sm flex items-center gap-2">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <button onclick="openModal('modalEditPromo')" class="text-[#3E81AB] hover:text-[#2C5F7C] font-medium flex items-center gap-1">
                                            EDIT
                                        </button>
                                    </td>
                                </tr>
